...
////////////////////////////////////////////////////////////////////////////////
void smt::Meanshift::setBandwidth(float bandwidth)
{
  bandwidth_ = bandwidth;
}

////////////////////////////////////////////////////////////////////////////////
float smt::Meanshift::getBandwidth() const
{
  return bandwidth_;
}

////////////////////////////////////////////////////////////////////////////////
void smt::Meanshift::setKernelType(smt::Meanshift::KERNEL_TYPE kernelType)
{
  kernelType_ = kernelType;
}

////////////////////////////////////////////////////////////////////////////////
float smt::Meanshift::getKernelType() const
{
  return kernelType_;
}

////////////////////////////////////////////////////////////////////////////////
void smt::Meanshift::setMaxModeInlierDistance(float maxModeInlierDistance)
{
  maxModeInlierDistance_ = maxModeInlierDistance;
}

////////////////////////////////////////////////////////////////////////////////
float smt::Meanshift::getMaxModeInlierDistance() const
{
  return maxModeInlierDistance_;
}
 
////////////////////////////////////////////////////////////////////////////////
bool smt::Meanshift::setInputPoints(const Eigen::MatrixXf& points)
{
...
////////////////////////////////////////////////////////////////////////////////
bool smt::Meanshift::cluster(Eigen::MatrixXf &unprunedModes)
{
  //----------------------------------------------------------------------------
  ...
  for (size_t pointId = 0; pointId < numPoints_; pointId++)
    for (size_t dId = 0; dId < dimensionality_; dId++)
...
////////////////////////////////////////////////////////////////////////////////
bool smt::Meanshift::pruneModes(Eigen::MatrixXf &prunedModes, std::vector<std::vector<int> > &prunedModeSupport)
{
  //----------------------------------------------------------------------------
  ...
  for (size_t pointId = 0; pointId < prunedModes_->size(); pointId++)
    for (size_t dId = 0; dId < dimensionality_; dId++)
