#ifndef MIN_CUT_PLANE_SEGMENTATION_HPP
#define MIN_CUT_PLANE_SEGMENTATION_HPP
...
namespace alg
{
  ...
  bool minCutPlaneSegmentation  ( const typename pcl::PointCloud<PointT>::ConstPtr &cloud,
...
#endif    // MIN_CUT_PLANE_SEGMENTATION_HPP